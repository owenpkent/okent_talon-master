...
default_alphabet = "alpha bravo charlie Delta echo foxtrot golf hotel india Juliet kilo Lima Mike November Oscar Poppa Québec romeo Sierra Tango uniform Victor whiskey x-ray Yankee zip".split(
    " "
)
